...
import './culturalwritingconversation.css';

function CulturalWritingConversation() {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            if (response.data.reply === "AI_TAKEOVER") {
                ...
                const prompt = `Provide a concise, culturally respectful one or two sentence response to: "${userInput}"`;
                try {
        ...
        <div className="conversation-container">
            <Container fluid className="mt-4">
                <Row className="justify-content-md-center pt-5">
                    <Col xs={12}>
                        <h1 className="text-center">Cultural Writing Conversation</h1>
                    </Col>
                </Row>
...
export default CulturalWritingConversation;
